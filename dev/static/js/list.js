...
var _header = require('public/module/header');

var _header2 = _interopRequireDefault(_header);

var _footer = require('public/module/footer');

var _footer2 = _interopRequireDefault(_footer);

var _jumbotron = require('./module/jumbotron');

var _jumbotron2 = _interopRequireDefault(_jumbotron);

var _listing = require('./module/listing');

var _listing2 = _interopRequireDefault(_listing);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _header2.default)((0, _jquery2.default)("#js-header"));

(0, _footer2.default)((0, _jquery2.default)("#js-footer"));

(0, _jumbotron2.default)((0, _jquery2.default)("#js-jumbotron"));

(0, _listing2.default)((0, _jquery2.default)("#js-listing"));

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./module/jumbotron":3,"./module/listing":6,"public/module/footer":10,"public/module/header":13}],2:[function(require,module,exports){
...
},{"hbsfy/runtime":87}],3:[function(require,module,exports){
(function (global){
'use strict';
...
exports.default = function () {
	var $box = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _jquery2.default)("body");

	_service2.default.renderData().then(function (data) {
		$box.html((0, _index2.default)(data));
	});
};

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./index.hbs":2,"./service":4}],4:[function(require,module,exports){
(function (global){
'use strict';
...
},{"public/demo-data":8}],5:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"col-md-4\">\n    <h2>"
    ...
    + "</h2>\n    <p>"
    + alias4(((helper = (helper = helpers.desc || (depth0 != null ? depth0.desc : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"desc","hash":{},"data":data}) : helper)))
    + "</p>\n    <p><a class=\"btn btn-default\" href=\"article.html?id="
...
},{"hbsfy/runtime":87}],6:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./index.hbs":5,"./service":7}],7:[function(require,module,exports){
(function (global){
'use strict';
...
},{"babel-runtime/core-js/get-iterator":15,"public/demo-data":8}],8:[function(require,module,exports){
"use strict";
...
},{"hbsfy/runtime":87}],10:[function(require,module,exports){
'use strict';
...
exports.default = function () {
    var $box = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $("body");

    _service2.default.footerText().then(function (data) {
        $box.html((0, _index2.default)(data));
    });
};

},{"./index.hbs":9,"./service":11}],11:[function(require,module,exports){
(function (global){
'use strict';
...
},{"public/demo-data":8}],12:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
  ...
  return "<div class=\"container\">\r\n    <div class=\"navbar-header\">\r\n        <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\">\r\n            <span class=\"sr-only\">Toggle navigation</span>\r\n            <span class=\"icon-bar\"></span>\r\n            <span class=\"icon-bar\"></span>\r\n            <span class=\"icon-bar\"></span>\r\n        </button>\r\n        <a class=\"navbar-brand\" href=\"/\">"
    + container.escapeExpression(((helper = (helper = helpers.sysName || (depth0 != null ? depth0.sysName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"sysName","hash":{},"data":data}) : helper)))
    + "</a>\r\n    </div>\r\n    <div id=\"navbar\" class=\"collapse navbar-collapse\">\r\n        <ul class=\"nav navbar-nav\">\r\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.nav : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </ul>\r\n    </div>\r\n    <!--/.nav-collapse -->\r\n</div>\r\n";
},"useData":true});
...
var _header = require('./header.hbs');
...
exports.default = function () {
    ...
    _q2.default.all([_service2.default.siteName(), _service2.default.navList()]).then(function (data) {
        tempData.sysName = data[0];
        tempData.nav = data[1];

        $box.html((0, _header2.default)(tempData));
    });
};

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./header.hbs":12,"./service":14}],14:[function(require,module,exports){
(function (global){
'use strict';
...
},{"public/demo-data":8}],15:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/get-iterator"), __esModule: true };
},{"core-js/library/fn/get-iterator":16}],16:[function(require,module,exports){
require('../modules/web.dom.iterable');
require('../modules/es6.string.iterator');
module.exports = require('../modules/core.get-iterator');
},{"../modules/core.get-iterator":64,"../modules/es6.string.iterator":66,"../modules/web.dom.iterable":67}],17:[function(require,module,exports){
...
},{"./_to-index":55,"./_to-iobject":57,"./_to-length":58}],21:[function(require,module,exports){
...
},{"./_cof":22,"./_wks":62}],22:[function(require,module,exports){
...
},{"./_descriptors":26,"./_object-dp":44,"./_property-desc":49}],34:[function(require,module,exports){
...
},{"./_hide":33,"./_object-create":43,"./_property-desc":49,"./_set-to-string-tag":51,"./_wks":62}],39:[function(require,module,exports){
'use strict';
...
},{"./_export":29,"./_has":32,"./_hide":33,"./_iter-create":38,"./_iterators":41,"./_library":42,"./_object-gpo":46,"./_redefine":50,"./_set-to-string-tag":51,"./_wks":62}],40:[function(require,module,exports){
...
},{"./_an-object":19,"./_dom-create":27,"./_enum-bug-keys":28,"./_html":34,"./_object-dps":45,"./_shared-key":52}],44:[function(require,module,exports){
var anObject       = require('./_an-object')
...
},{"./_an-object":19,"./_descriptors":26,"./_ie8-dom-define":35,"./_to-primitive":60}],45:[function(require,module,exports){
var dP       = require('./_object-dp')
...
},{"./_an-object":19,"./_descriptors":26,"./_object-dp":44,"./_object-keys":48}],46:[function(require,module,exports){
...
},{"./_has":32,"./_shared-key":52,"./_to-object":59}],47:[function(require,module,exports){
var has          = require('./_has')
...
},{"./_array-includes":20,"./_has":32,"./_shared-key":52,"./_to-iobject":57}],48:[function(require,module,exports){
...
},{"./_enum-bug-keys":28,"./_object-keys-internal":47}],49:[function(require,module,exports){
...
},{"./_hide":33}],51:[function(require,module,exports){
...
},{"./_has":32,"./_object-dp":44,"./_wks":62}],52:[function(require,module,exports){
...
},{"./_global":31}],54:[function(require,module,exports){
...
},{"./_defined":25,"./_to-integer":56}],55:[function(require,module,exports){
var toInteger = require('./_to-integer')
  , max       = Math.max
  , min       = Math.min;
...
},{"./_defined":25,"./_iobject":36}],58:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./_defined":25}],60:[function(require,module,exports){
...
},{"./_is-object":37}],61:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
$exports.store = store;
},{"./_global":31,"./_shared":53,"./_uid":61}],63:[function(require,module,exports){
...
},{"./_classof":21,"./_core":23,"./_iterators":41,"./_wks":62}],64:[function(require,module,exports){
var anObject = require('./_an-object')
...
},{"./_an-object":19,"./_core":23,"./core.get-iterator-method":63}],65:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":18,"./_iter-define":39,"./_iter-step":40,"./_iterators":41,"./_to-iobject":57}],66:[function(require,module,exports){
'use strict';
...
},{"./_iter-define":39,"./_string-at":54}],67:[function(require,module,exports){
...
},{"./_global":31,"./_hide":33,"./_iterators":41,"./_wks":62,"./es6.array.iterator":65}],68:[function(require,module,exports){
'use strict';
...
},{"./handlebars/base":69,"./handlebars/exception":72,"./handlebars/no-conflict":82,"./handlebars/runtime":83,"./handlebars/safe-string":84,"./handlebars/utils":85}],69:[function(require,module,exports){
'use strict';
...
},{"./decorators":70,"./exception":72,"./helpers":73,"./logger":81,"./utils":85}],70:[function(require,module,exports){
'use strict';
...
},{"./decorators/inline":71}],71:[function(require,module,exports){
'use strict';
...
},{"../utils":85}],72:[function(require,module,exports){
'use strict';
...
},{"./helpers/block-helper-missing":74,"./helpers/each":75,"./helpers/helper-missing":76,"./helpers/if":77,"./helpers/log":78,"./helpers/lookup":79,"./helpers/with":80}],74:[function(require,module,exports){
'use strict';
...
},{"../exception":72,"../utils":85}],76:[function(require,module,exports){
'use strict';
...
},{"../exception":72}],77:[function(require,module,exports){
'use strict';
...
},{"./base":69,"./exception":72,"./utils":85}],84:[function(require,module,exports){
...
},{"./dist/cjs/handlebars.runtime":68}],87:[function(require,module,exports){
